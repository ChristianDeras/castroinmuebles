                ...
                <h3>Servicios:</h3>
                    <div class="col-md-12 col-sm-12 col-xxl-12">
                        <div class=" data d-flex justify-content-center align-items-center ">
                            <ul class="font-rowdies-scalable d-flex justify-content-center flex-wrap ul-info align-items-center">
                    ...
                    <div class="col-md-12 col-sm-12 col-xxl-12">
                        <button type="submit" class="btn btn-color" data-bs-toggle="modal" data-bs-target="#exampleModal">Abrir 360°</button>
                    </div>
            </div>
            <div class="col-md-6 col-sm-12">
                ...
                <div class="row g-3">
                    <div class="col-md-6 col-sm-12 col-xxl-12  ">
                        <div class="data d-flex justify-content-around align-items-center ">
                            ...
                            <span class="font-rowdies-scalable">Habitaciones:  <span><b>{{$vivienda->habitaciones}}</b></span></span>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-12 col-xxl-12">
                        <div class="data d-flex justify-content-around align-items-center ">
                            ...
                            <span class="font-rowdies-scalable">Cantidad de baños: <span><b>{{$vivienda->sanitarios}}</b></span></span>
                        </div>
                    </div>
                    <div class="col-md-12 col-sm-12 col-xxl-12  ">
                        <div class="data d-flex justify-content-center align-items-center ">
                            ...
                            <span class="font-rowdies-scalable">Cantidad de plantas: <span><b>{{$vivienda->plantas}}</b></span></span>
                        </div>
                    </div>
                    <h3>Descripcion:</h3>
                    <div class="col-md-12 col-sm-12 col-xxl-12">
