      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-6">
              ...
              <div class="list">
                <ul>
                  ...
                  <li>Nos comprometemos por medio de un contrato a realizar el trámite (previa revisión y verificación
                    de que es posible realizarlo)</li>
                  <li>Luego de la presentacion del servicio le enviamos una encuesta de satisfacción</li>
                  <li>Tenemos dos modalidades de pago: 1. Subscripción mensual, en este caso tendrá derecho a solicitar tramites cada més
          ...
          <div class="row">
            ...
            <div class="col-12">
                    <label for="edad" class="form-label">Tipo de documento de identificación, DUI o pasaporte (Se usará para elaborar contrato)</label>
      ...
      <li>
        <div class="container">
          <div class="row d-flex flex-column">
            ...
            <div class="row mt-3">
              <div class="col-md-6 col-sm-12 d-flex justify-content-center align-items-center d-none d-sm-none d-md-flex" >
              ...
              <div class="col-md-6 col-sm-12 d-flex  justify-content-center flex-column">
                ...
                <a href="/remodelaciones/create" class="text-decoration-none btn btn-dark text-light">Acceder al servicio</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row d-flex flex-column">
            ...
            <div class="row mt-3 d-flex justify-content-center">
              ...
              <div class="col-md-6 col-sm-12 d-flex align-items-center justify-content-center flex-column">
                ...
                <a href="/corretajes/create" class="text-decoration-none btn btn-dark text-light">Acceder al servicio</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="d-flex justify-content-center mt-5 scale aniview " data-av-animation="slideInUp">
            <div class="card d-flex flex-row align-items-center overflow-hidden w-100">
              ...
              <div class="card-body">
                ...
                <p class="card-text">El mejor servicio para poder vender tu propiedad.</p>
                <button type="button" class="btn btn-success btn-color "><a href="/corretajes/create" class="text-decoration-none font-primary">Acceder al servicio</a></button>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="d-flex justify-content-center mt-5 scale aniview " data-av-animation="slideInUp">
            <div class="card d-flex flex-row align-items-center overflow-hidden w-100 ">
              ...
              <div class="card-body">
                ...
                <button type="button" class="btn btn-success btn-color"><a href="/remodelaciones/create" class="text-decoration-none font-primary">Acceder al servicio</a></button>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="profile-card-4 text-center aniview" data-av-animation="pulse"><img src="/Img/hero.webp"
            ...
            <div class="profile-content mt-3">
              ...
              <div class="row d-flex ">
                ...
                <div class="col-12">
                  <div class="profile-overview">
                    <button class="btn btn-success"><a href="/viviendas/{{$vivienda->id}}" class="text-decoration-none" style="color:white;">Más información</a></button>
                  </div>
                </div>
              </div>
            </div>
