...
<div class="container">
    ...
    <div class="row mt-5 d-flex align-items-center justify-content-center position-relative ">
        ...
        <div class="col-md-6 col-sm-12">
            <form class="row g-3 needs-validation p-3 border rounded-2 bg-white" action="/remodelaciones" method="POST" novalidate>
            @csrf    
            <div class="col-12">
                ...
                <div class="col-12">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio"  id="inline1" value="Remodelacion" name="tipo" required>
                ...
                <div class="col-4">
                    ...
                    <input type="text" class="form-control" id="presupuesto" name="presupuesto" aria-label="Amount (to the nearest dollar)" required>
                    <div class="valid-feedback">
                        Todo bien
                    </div>
                    <div class="invalid-feedback">
